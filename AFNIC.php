 ...
 * @license MIT
 */
class Registrar_Adapter_AFNIC extends Registrar_AdapterAbstract
{
    public $config = array();
    public $socket;
    public $isLogined;
    ...
    <epp xmlns="urn:ietf:params:xml:ns:epp-1.0"
      ...
      <command>
        ...
        <clTRID>{{ clTRID }}</clTRID>
            ...
            $to[] = $c_id;
            $from[] = '/{{ firstname }}/';
            $to[] = htmlspecialchars($client->getFirstName());
            $from[] = '/{{ lastname }}/';
            $to[] = htmlspecialchars($client->getLastName());
            $from[] = '/{{ org }}/';
...
<epp xmlns="urn:ietf:params:xml:ns:epp-1.0"
  ...
  <command>
    ...
    public function write($xml)
    {
        ...
        $r->registerXPathNamespace('frnic', 'http://www.afnic.fr/xml/epp/frnic-2.0');
            }
